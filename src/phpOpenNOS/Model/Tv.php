...
class Tv
{
    ...
    static public function fromXml($xml)
    {
        $tv = new Tv();
        $tv->setId($xml->id);
        $tv->setChannelCode((string) $xml->channel_code);
        $tv->setChannelIcon((string) $xml->channel_icon);
        $tv->setChannelName((string) $xml->channel_name);
        $tv->setDescription((string) $xml->description);
        $tv->setEndtime((string) $xml->endtime);
        $tv->setGenre((string) $xml->genre);
        $tv->setStarttime((string) $xml->starttime);
        $tv->setTitle((string) $xml->title);
